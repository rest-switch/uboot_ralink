...
#define CFG_USER_SIZE		0x10000
#define CFG_USER_ADDR		(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE)
#define CFG_KERN_ADDR1		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE + CFG_USER_SIZE))
